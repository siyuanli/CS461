 ...
 * @author Dale Skrien
 */
public class MidiPlayerWTrivalLB {
    private static final int NUM_TRACKS = 8;

    private final String BRACESINSTRING = "This is {a test} for left braces '{{{' in a string";
    private final String BRACESINSTRING2 = "This is {a test} for left braces \"{{{ in a string";
    private final char BRACESINCHRACTER = '{';
    ...
    /**
     * Creates a new MidiPlayerWTrivalLB with the given parameters.
     *
     * @param resolution     the number of ticks per beat
     * @param beatsPerMinute the number of beats per minute
     */
    MidiPlayerWTrivalLB(int resolution, int beatsPerMinute) {
